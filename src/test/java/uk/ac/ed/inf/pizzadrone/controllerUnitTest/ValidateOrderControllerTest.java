...
@SpringBootTest
public class ValidateOrderControllerTest {
    ...
    private static final Logger logger = Logger.getLogger(ValidateOrderControllerTest.class.getName());
    ...
    @Test
    public void testValidateOrders() throws Exception {
        ...
        for (Map<String, Object> order : orders) {
            ...
            mockMvc.perform(post("/validateOrder")
                    ...
                    .andExpect(status().is(isValid ? 200 : 400))
                    .andExpect(jsonPath("$.valid").value(isValid));
        }
    }
}
